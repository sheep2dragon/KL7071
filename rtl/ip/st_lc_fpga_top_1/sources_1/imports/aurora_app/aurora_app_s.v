...
begin
	if(reset)
		...
		case(m_axis_tdata_rfifo_2dly[27:20])                        
			8'd0:	vc_trans_data[CH_INDEX0*32-1:0]				 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd1:	vc_trans_data[CH_INDEX1*32-1:CH_INDEX0*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd2:	vc_trans_data[CH_INDEX2*32-1:CH_INDEX1*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd3:	vc_trans_data[CH_INDEX3*32-1:CH_INDEX2*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd4:	vc_trans_data[CH_INDEX4*32-1:CH_INDEX3*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd5:	vc_trans_data[CH_INDEX5*32-1:CH_INDEX4*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd6:	vc_trans_data[CH_INDEX6*32-1:CH_INDEX5*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd7:	vc_trans_data[CH_INDEX7*32-1:CH_INDEX6*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd8:	vc_trans_data[CH_INDEX8*32-1:CH_INDEX7*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd9:	vc_trans_data[CH_INDEX9*32-1:CH_INDEX8*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd10:	vc_trans_data[CH_INDEX10*32-1:CH_INDEX9*32] 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd11:	vc_trans_data[CH_INDEX11*32-1:CH_INDEX10*32] 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd12:	vc_trans_data[CH_INDEX12*32-1:CH_INDEX11*32] 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd13:	vc_trans_data[CH_INDEX13*32-1:CH_INDEX12*32] 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			default: ;
		endcase
	else ;
end
...
begin
	if(reset)
		...
		case(m_axis_tdata_rfifo_2dly[27:20])
			8'd0:	st_trans_data[CH_INDEX0*32-1:0]				 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd1:	st_trans_data[CH_INDEX1*32-1:CH_INDEX0*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd2:	st_trans_data[CH_INDEX2*32-1:CH_INDEX1*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd3:	st_trans_data[CH_INDEX3*32-1:CH_INDEX2*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd4:	st_trans_data[CH_INDEX4*32-1:CH_INDEX3*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd5:	st_trans_data[CH_INDEX5*32-1:CH_INDEX4*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd6:	st_trans_data[CH_INDEX6*32-1:CH_INDEX5*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd7:	st_trans_data[CH_INDEX7*32-1:CH_INDEX6*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd8:	st_trans_data[CH_INDEX8*32-1:CH_INDEX7*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd9:	st_trans_data[CH_INDEX9*32-1:CH_INDEX8*32] 		<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd10:	st_trans_data[CH_INDEX10*32-1:CH_INDEX9*32] 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd11:	st_trans_data[CH_INDEX11*32-1:CH_INDEX10*32] 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd12:	st_trans_data[CH_INDEX12*32-1:CH_INDEX11*32] 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			8'd13:	st_trans_data[CH_INDEX13*32-1:CH_INDEX12*32] 	<= {16'd0, m_axis_tdata_rfifo_2dly[7:0], m_axis_tdata_rfifo_2dly[15:8]};
			default: ;
		endcase
	else ;
end
